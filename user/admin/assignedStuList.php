  ...
  <div id="breadcrumb">
    <ul>
      ...
      <li ><a href="adminLogin.php">Admin Home</a></li>
	   <li>&#187;</li>
      <li class="current"><a href="assStudentSub.php">Assigned student</a></li>
    </ul>
  </div>
</div>
<!-- ####################################################################################################### -->
<div class="wrapper col3">
  <div id="container">
	...
	<div id="content">
  <center><h1>All assigned student list</h1></center>  
	<center>
	<form  method="post">
	Subject Id: <input type="text" name="searchVal" placeholder="ID"></input>	
	 ...
	 if(($_SERVER ["REQUEST_METHOD"]=="POST") && isset($_POST["submitSearch"]))
	{
		...
		$query = "SELECT * FROM subject where subject_id = '".$serVal."'";
		$result = oci_parse($connect, $query);
		
		oci_execute($result);
		echo '<center><b>Subject Detalis</b></center>';
		echo '<br/>';
		echo '<table border="1">';
		if($row = oci_fetch_array($result, OCI_BOTH)) 
		{
			echo '<tr>';
				echo '<td width="100" height="10"> Subject ID</td>';
				echo '<td width="250px" height="10">'.$serVal.'</td>';
			echo '</tr>';
			echo '<tr>';
				echo '<td width="100" height="10"> Subject Name</td>';
				echo '<td width="250px" height="10">'.$row[1].'</td>';
			echo '</tr>';
			echo '<tr>';
				echo '<td width="100" height="10"> Class</td>';
				echo '<td width="250px" height="10">'.$row[2].'</td>';
			echo '</tr>';
			echo '<tr>';
				echo '<td width="100" height="10"> Teacher Id</td>';
				echo '<td width="250px" height="10">'.$row[3].'</td>';
			echo '</tr>';
			echo '<tr>';
				echo '<td width="100" height="10"> Class Time</td>';
				echo '<td width="250px" height="10">'.$row[4].'</td>';
			echo '</tr>';
			echo '<tr>';
				echo '<td width="100" height="10">Day</td>';
				echo '<td width="250px" height="10">'.$row[5].'</td>';
			echo '</tr>';
			echo '<tr>';
				echo '<td width="100" height="10"> Year</td>';
				echo '<td width="250px" height="10">'.$row[6].'</td>';
			echo '</tr>';
		}
		echo '</table>';
		
		$count=1;
		$query2 = "SELECT St_id FROM student_sub where sub_id = ".$serVal."";
		$result2 = oci_parse($connect, $query2);
		
		oci_execute($result2);
		
		echo '<br/>';
		echo '<center><b> Student List</b></center>';
		echo '<br/>';
		echo '<table border="1">';
		while($row2 = oci_fetch_array($result2, OCI_BOTH)) 
		{
			echo '<tr>';
				echo '<td width="100" height="10"> Student Id :' .$count.'</td>';
				echo '<td width="250px" height="10">'.$row2[0].'</td>';
			echo '</tr>';
			$count++;
		}
		if($count == 1)
		{
			echo '<tr>';
				echo '<td width="100" height="10"> Student Id :' .$count.'</td>';
				echo '<td width="250px" height="10">No Student Added</td>';
			echo '</tr>';
			
			echo "<script language=\"javascript\">";
			echo "var question=confirm(\"Sorry!! No student added yet.\");"; 
			echo "</script>";
			//$count=0;
		...
		echo '<br/><br/>';
		$count--;
		echo '<center><b>Total number of student = '.$count.'</b></center>';
	}
