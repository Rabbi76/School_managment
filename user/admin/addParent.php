...
<?php
	...
	if(($_SERVER ["REQUEST_METHOD"]=="POST") && isset($_POST["submit"]))
	{
		...
		$pw=$_POST["password"];
			...
			$query = "insert into parent_info values ('".$id."','".$name."','".$address."',".$phone.",'".$email."')";
			
			$query2 = "insert into school_user_login values ('".$id."','".$pw."','parent')";
  ...
  <div id="breadcrumb">
    <ul>
      ...
      <li ><a href="adminLogin.php">Admin Home</a></li>
	   <li>&#187;</li>
      <li class="current"><a href="addParent.php">Add Parent</a></li>
    </ul>
  </div>
</div>
<!-- ####################################################################################################### -->
<div class="wrapper col3">
  <div id="container">
	...
	<div id="content">
    <center><h1>Add Parent Info</h1></center>  
	<form method ="post">
	<table border="1">
		<tr>
