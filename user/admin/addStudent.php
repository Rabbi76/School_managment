...
<?php
	...
	if(($_SERVER ["REQUEST_METHOD"]=="POST") && isset($_POST["submit"]))
	{
		...
		$pw=$_POST["password"];
			...
			$query = "insert into student_info values ('".$id."','".$name."','".$fname."','".$mname."','".$address."',".$class.",".$phone.",'".$email."','NU')";
			$query2 = "insert into school_user_login values ('".$id."','".$pw."','student')";
			
			$stid = oci_parse($connect, $query);
			oci_execute($stid);
			
			$stid1 = oci_parse($connect, $query2);
			oci_execute($stid1);
			
			echo '<script language="javascript">';
			echo 'alert("New Student Added")';
			echo '</script>';
  ...
  <div id="breadcrumb">
    <ul>
      ...
      <li ><a href="adminLogin.php">Admin Home</a></li>
	   <li>&#187;</li>
      <li class="current"><a href="addStudent.php">Add Student</a></li>
    </ul>
  </div>
</div>
<!-- ####################################################################################################### -->
<div class="wrapper col3">
  <div id="container">
	...
	<table border="1">
		<tr>
			<td width="100" height="10">Select Class</td>
			<td width="100" height="10">
				<center><select name="selectclass" id="sc" style="width:250px;">
		...
		<tr>
			<td width="100" height="10">Father's Name</td>
			<td>
				<center><input type="text" name="fname" style="width:250px;"/></center>
			</td>
		</tr>
		<tr>
			<td width="100" height="10">Mother's Name</td>
			<td>
				<center><input type="text" name="mname" style="width:250px;"/></center>
			</td>
		</tr>
		<tr>
