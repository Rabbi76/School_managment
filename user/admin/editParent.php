...
<?php
	...
	if(($_SERVER ["REQUEST_METHOD"]=="POST") && isset($_POST["submitUpdate"]))
	{
			...
			$query = "UPDATE parent_info SET full_name = '".$name."', address = '".$address."', phone =".$phone." ,email = '".$email."' WHERE parent_id='".$userId."'";
  ...
  <div id="breadcrumb">
    <ul>
      ...
      <li ><a href="adminLogin.php">Admin Home</a></li>
	   <li>&#187;</li>
      <li class="current"><a href="editParent.php">Edit  Parent</a></li>
    </ul>
  </div>
</div>
<!-- ####################################################################################################### -->
<div class="wrapper col3">
  <div id="container">
	...
	<div id="content">
     <center><h1>Edit Parent Info</h1></center>  
	<form  method="post">
		<center>
	 ...
	 if(($_SERVER ["REQUEST_METHOD"]=="POST") && isset($_POST["submitSearch"]))
	{
		...
		$connect = oci_connect("HR", "rat", "localhost/XE");
		$query = "SELECT * FROM parent_info where parent_id = '".$serVal."'";
		...
		elseif(!$row = oci_fetch_array($result, OCI_BOTH))
		{
			...
			echo '<tr>';
				echo '<td width="200" height="20">ID</td>';
				echo '<td width="250px" height="20">'.'No ID select'.'</td>';
				//echo '<td>';
			...
			echo '<tr>';
				echo '<td width="200" height="20">Name</td>';
				echo '<td>';
					echo '<center><input type="text" name="idname" value="" style="width:250px;"/></center>';
				echo '</td>';
			echo '</tr>';
			echo '<tr>';
				echo '<td width="200" height="20">Email:</td>';
				echo '<td>';
					echo '<center><input type="text" name="ename" value="" style="width:250px;"/></center>';
				echo '</td>';
			echo '</tr>';
			echo '<tr>';
				echo '<td width="200" height="20">Phone:</td>';
			...
			echo "<script language=\"javascript\">";
			echo "var question=confirm(\"Sorry!! Wrong Teacher ID.\");"; 
			echo "</script>";
