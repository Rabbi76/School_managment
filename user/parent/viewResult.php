...
<div class="wrapper col1">
  <div id="header">
    ...
    <div id="topnav">
      <ul>
        <li > <a href="parentLogin.php">Home</a></li>
...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      ...
      <li>&#187;</li>
      <li class="current"><a href="parentLogin.php">View Result</a></li>
    </ul>
  </div>
</div>
<!-- ####################################################################################################### -->
<div class="wrapper col3">
  <div id="container">
	...
	<?php
		...
		$query = "select * from student_parent where pr_id='$userId'";
		...
		while($row = oci_fetch_array($result, OCI_BOTH)) 
		{
			if($cou==0)
			{
				echo 'student ID : <select name="stuId" >';
		...
		if($cou==0)
		{
			echo '<br/><br/>Sorry No student added in Your Account!!!';
			echo '<script language="javascript">'; 
			echo 'alert("Sorry No student added in Your Account!!!")';
			echo '</script>';
		}
		echo '</center> &nbsp &nbsp';
		echo '&nbsp &nbsp <input type="submit" name="selStu" value="Select Student "/>';
		echo '</form>';
		echo '<br/><br/>';
		
		if(($_SERVER ["REQUEST_METHOD"]=="POST") && isset($_POST["selStu"]))
		{
			$stuId=$_POST['stuId'];
			$year='2016';
			...
			{
				echo "<script>
				alert('Select The Student Please!!!');
				</script>";
			}
			else
			{
				$count=0;
				$query = "SELECT * FROM student_sub where (St_id = '".$stuId."' and year = '".$year."') ORDER BY sub_id ASC";
