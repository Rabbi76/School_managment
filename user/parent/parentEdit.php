  ...
  <div id="header">
    ...
    <div id="topnav">
      <ul>
        ...
        <li class="active"><a href="parentEdit.php">Account setting</a></li>
      </ul>
    </div>
    <br class="clear" />
  </div>
...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
	  ...
	  <li>&#187;</li>
      <li class="current"><a href="teacherInfo.php">Edit Info</a></li>
    </ul>
  </div>
</div>
<!-- ####################################################################################################### -->
  ...
  <div id="container">
	...
	<table border="1">
	 <?php
		...
		$connect = oci_connect("HR", "rat", "localhost/XE");
		//echo $userId;
		$query = "SELECT * FROM parent_info where parent_id = '".$userId."'";
