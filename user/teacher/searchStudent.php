  ...
  <div id="header">
    ...
    <div id="topnav">
      <ul>
        ...
        <li  class="active"><a href="searchStudent.php">Search Studentt</a></li>
  ...
  <div id="container">
	...
	<?php 
		...
		if(($_SERVER ["REQUEST_METHOD"]=="POST") && isset($_POST["searchStu"]))
		{
			...
			{
				$count=0;
				$query = "SELECT St_id FROM student_sub where (sub_id = '".$subId."')";
				...
				while($row1 = oci_fetch_array($result, OCI_BOTH)) 
				{
					if($count==0)
					{
						...
						echo '<tr>';
							...
							echo '<td width="15" height="15"><center>Result</center></td>';
							echo '<td width="60" height="15"><center>Father</center></td>';
							echo '<td width="15" height="15"><center>phone</center></td>';
						echo '</tr>';
						$count++;
					}
					$connect = oci_connect("HR", "rat", "localhost/XE");
					$query2 = "SELECT * FROM student_info where student_id like '%$row1[0]%'";
